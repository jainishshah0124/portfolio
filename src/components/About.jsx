...
const About = () => {
  return (
    <>
      ...
      {
        "Software Engineer with 6+ years of experience and strong fundamentals in Java, Object-Oriented Programming, and backend development. Knowledgeable in building and maintaining scalable applications using Java, Spring, JDBC, REST APIs, and SQL. Proficient in SDLC methodologies, data structures, automated testing, and backend performance optimization. Knowledgeable in cross-functional  collaboration with frontend, product, and QA teams, supporting architectural discussions and delivering production-ready systems. Professional in working within high-scale, customer-facing environments with a security-first and reliability-focused mindset."
      }
      <br></br>
      Skills :<br/>
      ● <b>Languages</b>: Java (Java 8+), JavaScript, TypeScript, Python, C++, SQL<br/>
      ● <b>Java & Backend Technologies</b>: J2EE, Spring Boot, Spring MVC, JDBC, REST APIs, Maven, JUnit, Hibernate<br/>
      ● <b>Frontend Technologies</b>: React.js, HTML5, CSS3, JavaScript, TypeScript<br/>
      ● <b>Databases</b>: Oracle, MySQL, PostgreSQL, SQL Server, MongoDB<br/>
      ● <b>Tools & Platforms</b>: Git, GitHub, Jenkins, Docker, Linux, Tomcat, Jira, Kubernetes
      </div>
